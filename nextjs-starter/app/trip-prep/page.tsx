...
export const metadata = {
    ...
    description: "Prepare for your Island Park backcountry ATV tour. View live National Park Service trails status, National Weather Service alerts, and expert guides.",
...
export default function TripPrepPage() {
    const jsonLd = {
        ...
        "description": "Essential preparation information and official external resources for backcountry ATV tours originating in Island Park, Idaho.",
        "relatedLink": [
            ...
            <main className="flex-grow bg-nomad-paper flex flex-col relative z-10 w-full overflow-hidden">
                ...
                <section className="py-24 relative border-b border-[rgba(0,0,0,0.1)] z-10">
                    <div className="container mx-auto px-4 text-center">
                        <span className="font-mono text-nomad-red text-sm tracking-widest mb-2 block font-bold">// TRIP PREPARATION</span>
                        ...
                        <p className="text-nomad-black font-medium text-xl max-w-3xl mx-auto drop-shadow-sm">
                            The backcountry surrounding Island Park and Yellowstone operates on its own terms. Before heading out on a Nomad Yellowstone ATV tour, consult these official channels for real-time updates.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                            ...
                            <div className="bg-nomad-black p-10 relative overflow-hidden group shadow-xl">
                                ...
                                <p className="text-nomad-paper mb-8 font-medium">
                                    Access live trail closures, wildlife migratory warnings, and official region alerts directly from the NPS updates covering the contiguous Yellowstone and Grand Teton zones.
                                </p>
                ...
                <section className="py-24 relative z-10 border-t border-[rgba(0,0,0,0.1)]">
                    <div className="container mx-auto px-4 max-w-4xl text-center">
                        <span className="font-mono text-nomad-red text-sm tracking-widest mb-2 block font-bold">// RECOMMENDED PACKING</span>
                        <h2 className="font-heading text-4xl text-nomad-black uppercase mb-12 text-distressed drop-shadow-sm">Recommended Gear</h2>
