        ...
        <div className="min-h-screen bg-nomad-black text-foreground font-body bg-topo">
            <header className="p-6 border-b border-white/5 glass-panel">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <nav className="space-x-8 text-xs font-mono tracking-widest text-nomad-paper/60 hidden md:block">
            ...
            <main className="container mx-auto px-4 py-20 max-w-3xl">
                ...
                <div className="prose prose-invert prose-lg text-nomad-paper/80">
