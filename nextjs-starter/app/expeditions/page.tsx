                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid md:grid-cols-3 gap-8 relative z-10 max-w-7xl mx-auto">
                            ...
                            <div className="glass-card group hover:-translate-y-2 transition-transform duration-300 mt-12 md:mt-0">
                                <div className="h-64 relative bg-gray-800 overflow-hidden">
                                    <Image src="/atv_action.png" alt="Sunset view of the Yellowstone caldera system accessed via a Golden Hour guided ATV tour from Island Park, Idaho." fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                                </div>
                                <div className="p-8">
