...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    const ogImage = post.image || '/sawtelle.png';
    ...
    return {
        ...
        openGraph: {
            title: post.title,
            description: post.description,
            url: `https://nomadyellowstone.com/intel/${slug}`,
        ...
        <div className="min-h-screen bg-nomad-black text-foreground font-body bg-topo">
            ...
            <article className="container mx-auto px-4 py-20 max-w-4xl">
                ...
                <div className="mb-12 text-center">
                    ...
                    <div className="flex items-center justify-center gap-6 text-nomad-paper/50 font-mono text-xs tracking-widest uppercase">
                        <span>{post.date}</span>
                        <span>//</span>
                ...
                <div className="bg-white/5 border-l-4 border-accent p-8 mb-12 rounded-r-sm">
                    ...
                    <p className="text-nomad-paper italic text-lg leading-relaxed">
                ...
                <div className="mt-20 p-8 glass-panel border border-white/10 rounded-sm flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                    <div className="w-24 h-24 bg-accent rounded-full flex items-center justify-center flex-shrink-0">
                        <span className="font-heading text-3xl text-nomad-black">N</span>
                    </div>
                    <div>
                        <h3 className="font-heading text-2xl text-white uppercase mb-2">Ready to Go?</h3>
                        <p className="text-nomad-paper/70 mb-6 max-w-lg">
