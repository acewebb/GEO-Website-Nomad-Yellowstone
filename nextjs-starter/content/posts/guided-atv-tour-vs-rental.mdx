...
<div className="bg-nomad-black/50 border-l-4 border-accent p-6 my-8">
  ...
  <p className="m-0 text-sm mb-2">Nomad Yellowstone runs guided ATV expeditions daily from Island Park, Idaho — just 20 minutes from West Yellowstone. Morning, Mid-Day, and Evening departures. No experience required.</p>
  <p className="m-0 text-xs font-mono">
    👉 For a complete breakdown of damage deposits, liability, and costs, check out our dedicated <a href="/rental-vs-guided" className="text-accent hover:underline font-bold">ATV Rental vs Guided Tour Comparison</a> or view <a href="/west-yellowstone-atv-tours" className="text-accent hover:underline font-bold">West Yellowstone ATV Tours</a>.
  </p>
</div>
...
**For larger groups**: Nomad Yellowstone's guided tours provide a dedicated guide, zero machine liability, helmets and goggles included, and access to the best backcountry views without navigation stress or hidden damage fees.
